...
struct HashChainArray<H: HashChain> {
    pub array_w1: Option<TinyVec<[TinyVec<[u8; MAX_HASH_SIZE]>; HASH_CHAIN_COUNT_W1 as usize]>>,
    pub array_w2: Option<TinyVec<[TinyVec<[u8; MAX_HASH_SIZE]>; HASH_CHAIN_COUNT_W2 as usize]>>,
    pub array_w4: Option<TinyVec<[TinyVec<[u8; MAX_HASH_SIZE]>; HASH_CHAIN_COUNT_W4 as usize]>>,
    pub array_w8: Option<TinyVec<[TinyVec<[u8; MAX_HASH_SIZE]>; HASH_CHAIN_COUNT_W8 as usize]>>,
