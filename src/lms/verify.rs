...
mod tests {
    ...
    fn test_verification() {
        ...
        let first_signature = LmsSignature::sign(&mut private_key, &first_message, None).unwrap();
        let second_signature = LmsSignature::sign(&mut private_key, &second_message, None).unwrap();
